...
//Valores de control para el timer del audio
...
static const char* ElegirChart(int num_cancion){
	if (num_cancion == 1){
		return "SYNC.CHT";
	}
...
int main(void)
{
    ...
    while (1) {
    	...
    	case MENU:
			...
			//a partir del ínidice que escoge el usuario
    	...
    	case INTRO:
    		...
    		if (Cargar_Chart(CHART_PATH) != XST_SUCCESS) {
