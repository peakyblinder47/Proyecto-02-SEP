...
proc update_PARAM_VALUE.TAM_ADDR_FIFO { PARAM_VALUE.TAM_ADDR_FIFO } {
	# Procedure called to update TAM_ADDR_FIFO when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TAM_ADDR_FIFO { PARAM_VALUE.TAM_ADDR_FIFO } {
	# Procedure called to validate TAM_ADDR_FIFO
	return true
}
...
proc update_MODELPARAM_VALUE.TAM_ADDR_FIFO { MODELPARAM_VALUE.TAM_ADDR_FIFO PARAM_VALUE.TAM_ADDR_FIFO } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TAM_ADDR_FIFO}] ${MODELPARAM_VALUE.TAM_ADDR_FIFO}
}
