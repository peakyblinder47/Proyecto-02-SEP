...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins ila_0/probe2] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net axi_timer_1_interrupt [get_bd_pins axi_timer_1/interrupt] [get_bd_pins ila_0/probe1] [get_bd_pins xlconcat_1/In2]
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins BUZZER_AXI_0/VIO_INPUT] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins ila_0/probe0] [get_bd_pins xlconcat_0/dout]
