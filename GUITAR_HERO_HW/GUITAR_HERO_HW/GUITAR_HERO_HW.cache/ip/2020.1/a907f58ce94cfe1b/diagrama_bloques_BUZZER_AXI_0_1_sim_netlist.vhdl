...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_BUZZER_AXI_v1_0_S00_AXI is
  ...
  signal escalado : STD_LOGIC_VECTOR ( 28 downto 6 );
  ...
  signal \fifo_read_puntero[9]_i_8_n_0\ : STD_LOGIC;
  signal \fifo_read_puntero[9]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \pwm_sample2_carry__4_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of PWM0_carry_i_14 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of PWM0_carry_i_17 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of PWM0_carry_i_18 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of PWM0_carry_i_20 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of PWM_INST_0 : label is "soft_lutpair33";
  ...
  attribute SOFT_HLUTNM of \axi_rdata[1]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \axi_rdata[20]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \axi_rdata[24]_i_1\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \axi_rdata[28]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \axi_rdata[29]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \axi_rdata[30]_i_1\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \axi_rdata[8]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \axi_rdata[9]_i_2\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \byte_select[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \byte_select[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of clear_fifo_i_1 : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of clear_flags_i_1 : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \fifo_read_puntero[1]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \fifo_read_puntero[2]_i_1\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \fifo_read_puntero[6]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \fifo_read_puntero[7]_i_1\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \fifo_read_puntero[9]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \fifo_write_puntero[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \fifo_write_puntero[2]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \fifo_write_puntero[6]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \fifo_write_puntero[7]_i_1\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \minusOp_carry__0_i_10\ : label is "soft_lutpair19";
  attribute ADDER_THRESHOLD of \minusOp_carry__1\ : label is 35;
  attribute SOFT_HLUTNM of mute_i_1 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of pause_i_1 : label is "soft_lutpair31";
  ...
  attribute SOFT_HLUTNM of play_i_1 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \pwm_counter[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \pwm_counter[2]_i_1\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \pwm_counter[6]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \pwm_counter[7]_i_1\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \sample_actual[7]_i_4\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of underflow_i_1 : label is "soft_lutpair18";
begin
...
PWM0_carry_i_20: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\fifo_read_puntero[9]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
...
\fifo_read_puntero[9]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFCFCFFFFFCEF"
    )
        port map (
      I0 => fifo_count_reg(9),
...
\fifo_read_puntero[9]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\fifo_read_puntero[9]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF9FFFFFFFFCCCF"
    )
        port map (
...
\fifo_read_puntero[9]_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\minusOp_carry__0_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\minusOp_carry__0_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5955555555555555"
    )
        port map (
...
\pwm_sample2_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \pwm_sample2_carry__4_i_1_n_0\,
