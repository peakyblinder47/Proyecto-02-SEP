...
HD_PWD='D:/Proyecto-02-SEP/GUITAR_HERO_HW/GUITAR_HERO_HW/GUITAR_HERO_HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log diagrama_bloques_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source diagrama_bloques_wrapper.tcl -notrace
