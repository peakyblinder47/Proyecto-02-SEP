...
HD_PWD='D:/Proyecto-02-SEP/GUITAR_HERO_HW/GUITAR_HERO_HW/GUITAR_HERO_HW.runs/diagrama_bloques_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log diagrama_bloques_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source diagrama_bloques_ila_0_0.tcl
