...
HD_PWD='D:/Proyecto-02-SEP/GUITAR_HERO_HW/GUITAR_HERO_HW/GUITAR_HERO_HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log diagrama_bloques_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source diagrama_bloques_wrapper.tcl
